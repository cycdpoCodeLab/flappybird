...
let OverScene = Hilo.Class.create({
  ...
  init: function (properties) {
    let board = new Hilo.Bitmap({
      id: 'board',
      image: properties.image,
      rect: [0, 0, 590, 298]
    });

    let gameover = new Hilo.Bitmap({
      id: 'gameover',
      image: properties.image,
      rect: [0, 298, 508, 158]
    });

    let startBtn = new Hilo.Bitmap({
      id: 'start',
      image: properties.image,
      rect: [590, 0, 290, 176]
    });

    let gradeBtn = new Hilo.Bitmap({
      id: 'grade',
      image: properties.image,
      rect: [590, 176, 290, 176]
    });

    let scoreLabel = new Hilo.BitmapText({
      id: 'score',
